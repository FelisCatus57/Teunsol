    ...
    <>
      ...
      <div className="h-[41.75rem] flex ">
        <div className="w-1/2 h-full flex flex-col justify-center items-center relative pb-16 ">
          <Image
            src={`${process.env.NEXT_PUBLIC_IMGURL}/homebody/contents1/img1.jpg`}
            alt="contents1"
            layout="fill"
            objectFit="cover"
          />
        ...
        <div className="w-1/2 h-full flex flex-col justify-center items-center relative overflow-hidden">
          <Image
            src={`${process.env.NEXT_PUBLIC_IMGURL}/homebody/contents1/img2.jpg`}
            alt="contents1"
            layout="fill"
            objectFit="cover"
          />
          ...
          >
            <div className="relative w-full h-full hover:scale-110 transition-transform duration-500 ease-in-out  ">
              <Image
                src={`${process.env.NEXT_PUBLIC_IMGURL}/homebody/contents1/img3.jpg`}
                alt="contents1"
                layout="fill"
                objectFit="cover"
              />
