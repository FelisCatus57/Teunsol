  ...
  return (
    <>
      ...
      <div className="h-[41.75rem] flex ">
        ...
        <Image
            src={`${process.env.NEXT_PUBLIC_IMG_PATH}/homebody/contents1/img1.jpg`}
            alt="contents1"
            layout="fill"
            objectFit="cover"
          />
        ...
        <Image
            src={`${process.env.NEXT_PUBLIC_IMG_PATH}/homebody/contents1/img2.jpg`}
            alt="contents1"
            layout="fill"
            objectFit="cover"
          />
          ...
          >
            ...
            <Image
                src={`${process.env.NEXT_PUBLIC_IMG_PATH}/homebody/contents1/img3.jpg`}
                alt="contents1"
                layout="fill"
                objectFit="cover"
              />
